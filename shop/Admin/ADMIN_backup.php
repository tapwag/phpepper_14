...
$dbhost="localhost";     // Rechnername, worauf die DB laeuft
$dbuser="v14_shop_adm";    // Name des DB-Benutzers
$dbpass='apwd'; // Passwort des DB-Benutzers
$dbname="v14_shop";      // Name der Datenbank
